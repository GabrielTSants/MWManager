...
class Category extends Model
{
  ...
  {
    $sql = $this->search(['id', 'name'], ['category.id' => $this->userId], 
    ['category_JOIN' => 'INNER JOIN user_category uc ON uc.fk_category = category.id', 
     'user_JOIN' => 'INNER JOIN user u ON uc.fk_user = u.id']);
